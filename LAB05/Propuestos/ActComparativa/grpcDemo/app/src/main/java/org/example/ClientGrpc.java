...
public class ClientGrpc {
    ...
    private final CalculatorServiceGrpc.CalculatorServiceBlockingStub blockingStub; // stub bloqueante para hacer llamadas al servidor
    ...
    public void add(double num1, double num2) { // para enviar solicitud de suma al servidor
    ...
    private static long usedMemoryBytes() { // para medir la memoria usada, resta la total menos la libre
        Runtime runtime = Runtime.getRuntime();
        return runtime.totalMemory() - runtime.freeMemory();
    }

    private static String formatMb(long bytes) {  // para formatear la memoria usada en MB
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("Variacion neta de memoria: " + formatMb(memoryDelta)); // variacion neta es la memoria final menos la inicial
