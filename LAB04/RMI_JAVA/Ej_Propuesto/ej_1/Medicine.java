...
public class Medicine implements Serializable { // para que el RMI transfiera por valor, no por referencia (no es un objeto remoto)

    private static final long serialVersionUID = 1L; // destino para compatibilidad de versiones
